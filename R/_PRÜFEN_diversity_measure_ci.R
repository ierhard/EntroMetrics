...
#
# Output: Calculate ci.lower = min(f(C)) and ci.upper = max(f(C)).
#         This is a conservative CI of the same level as the simultaneous CI.

diversity_measure_ci <- function(simultaneous_prop_ci.lower,
                                 simultaneous_prop_ci.upper,
  ...
  n_p <- length(simultaneous_prop_ci.lower)
  
  #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  # Maximization problem
  
  # Note: This is concave maximization problem, which is equivalent to a concave
  ...
  ci.lower <- min(extreme_point_values)
  
  ci <- c(ci.lower = ci.lower, ci.upper = ci.upper)
  ...
  return(
    ...
    list(ci = ci,
         ...
         extrmee_point_values = extreme_point_values
         )
...
# 
# diversity_measure_ci(lower_vec,
#                      upper_vec,
#                      "efficiency")$ci
# 
# 
