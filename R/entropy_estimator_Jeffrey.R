#' Bayesian entropy estimator with Jeffrey's Dirichlet prior
#'
#' @description
#' Bayesian entropy estimator based on Jeffrey's prior \eqn{\mathbf p \sim \operatorname{Dirichlet}\big((1/2, \dots, 1/2)\big)}
#'
#'
...
#' print(bin_counts)
#' entropy_estimator_Jeffrey(bin_counts)
#' entropy_estimator_Jeffrey(bin_counts, unit = "ln")
#' entropy_estimator_Jeffrey(bin_counts, unit = "normalize")
entropy_estimator_Jeffrey <- function(bin_counts,
