#' Bayesian entropy estimator with the Laplace Dirichlet prior
#'
#' @description
#' Bayesian entropy estimator based on the Laplace prior \eqn{\mathbf p \sim \operatorname{Dirichlet}\big((1, \dots, 1)\big)}
#'
#'
...
#' print(bin_counts)
#' entropy_estimator_Laplace(bin_counts)
#' entropy_estimator_Laplace(bin_counts, unit = "ln")
#' entropy_estimator_Laplace(bin_counts, unit = "normalize")
entropy_estimator_Laplace <- function(bin_counts,
